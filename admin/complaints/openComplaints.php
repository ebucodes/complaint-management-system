            ...
            <div class="col-12">
              ...
              <div class="card card-dark">
                <div class="card-header">
                  <h3 class="card-title">List of Open Complaints</h3>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
                  <table id="example1" class="table table-bordered table-striped table-sm">
                    ...
                    <tbody>
                      ...
                      if ($admin_info['category'] == 'Admin') {
                        ...
                        $query = mysqli_query($conn, 'SELECT complaint.*,user.fullName AS userID,category.categoryName AS category FROM complaint JOIN user ON user.userID=complaint.userID JOIN category ON category.categoryID=complaint.category WHERE status="Open" AND categoryName ="' . $admin_info['category'] . '"');
                      }
