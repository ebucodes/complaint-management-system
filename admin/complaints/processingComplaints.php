          ...
          <!-- Administrators list -->
            <div class="card card-dark">
              <div class="card-header">
                <h3 class="card-title">List of Processing Complaints</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                  ...
                  <tbody>
                    <?php 
                      if ($admin_info['category'] == 'Admin') {
                        ...
                        $query=mysqli_query($conn,'SELECT complaint.*,user.fullName AS userID,category.categoryName AS category FROM complaint JOIN user ON user.userID=complaint.userID JOIN category ON category.categoryID=complaint.category WHERE status="Processing" AND categoryName ="'.$admin_info['category'].'"');                            
                      }
