        ...
        <div class="row">
          <div class="col-12">
              ...
              <div class="card card-dark">
                ...
                <!-- /.card-header -->
                <div class="card-body">
                <a type="button" href="addFaculty.php" class="btn bg-gradient-dark"><i class="fa fa-plus-circle"></i> New Faculty</a>
                </div>
                <!-- /.card-body -->
              </div>
              <!-- /.card -->
                  ...
                  <tbody>
                    ...
                    include("../includes/config.php");
                          ...
                          <tr>
                            ...
                            <td>
                              <a type="button" rel="tooltip" title="Edit" href="editFaculty.php?id=<?php echo $row["facultyID"]; ?>" class="btn btn-success"><i class="fas fa-user-edit"></i> Edit</a>
                            </td>
                            <td>
                            <a type="button" href="deleteFaculty.php?id=<?php echo $row["facultyID"]; ?>" class="btnDel btn btn-danger"><i class="fas fa-user-minus"></i> Delete</a>
                          </td>
                          </tr>
