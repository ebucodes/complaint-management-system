              ...
              <div class="card card-dark">
                ...
                <div class="card-body">
                  <table id="example1" class="table table-bordered table-sm">
                    ...
                    <tbody>
                      <?php
                      $query = mysqli_query($conn, "SELECT * FROM complaint WHERE userID='" . $user_info['userID'] . "'");
                      ...
                      ?>
                        <tr>
                          ...
                          ?>
                          <td>
                            <a type="button" rel="tooltip" title="View" href="complaintDetails.php?id=<?php echo $row["complaintID"]; ?>" class="btn btn-primary"><i class="fas fa-eye"></i> More Details</a>
                          </td>
