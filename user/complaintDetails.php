              ...
              <div class="card card-dark">
                ...
                <div class="card-body">
                  <table id="example1" class="table table-bordered table-sm">
                    <tbody>
                      <?php
                      $query = mysqli_query($conn, "SELECT complaint.*,category.categoryName AS category FROM complaint JOIN category ON category.categoryID=complaint.category WHERE userID='" . $user_info['userID'] . "' AND complaintID='" . $_GET['id'] . "'");
