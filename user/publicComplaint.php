    ...
    <div class="content-wrapper">
      ...
      <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 class="m-0">Your Complaint History</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
              ...
              <div class="card card-dark">
                ...
                <div class="card-body">
                  <table id="example1" class="table table-bordered table-sm">
                    ...
                    <tbody>
                      <?php
                      $query = mysqli_query($conn, "SELECT * FROM complaint WHERE complaintVisibility='Public'");
                      ...
                      ?>
                        <tr>
                          ...
                          ?>
                          <td>
                            <a type="button" rel="tooltip" title="View" href="publicComplaintDetails.php?id=<?php echo $row["complaintID"]; ?>" class="btn btn-primary"><i class="fas fa-eye"></i> More Details</a>
                          </td>
